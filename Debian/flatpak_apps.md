...
| Name & Link | Description & Manual CLI Installation |
|---|---|
| [Steam Link](https://flathub.org/apps/com.valvesoftware.SteamLink) | `flatpak install flathub com.valvesoftware.SteamLink` <br> Stream games from another computer with Steam.|
| [Heroic Games Launcher](https://flathub.org/apps/com.heroicgameslauncher.hgl) | `flatpak install flathub com.heroicgameslauncher.hgl` <br> An Open Source Epic Games, GOG and Amazon Prime Games Launcher.|
| [Lutris](https://flathub.org/apps/net.lutris.Lutris) | `flatpak install flathub net.lutris.Lutris` <br> Lutris helps you install and play video games from all eras and from most gaming systems.|
| [ProtonPlus](https://flathub.org/apps/com.vysp3r.ProtonPlus) | `flatpak install flathub com.vysp3r.ProtonPlus` <br> Modern compatibility tools manager.|
| [Protontricks](https://flathub.org/apps/com.github.Matoking.protontricks) | `flatpak install flathub com.github.Matoking.protontricks` <br> This is often useful when a game requires closed-source runtime libraries or applications that are not included with Proton.|
| [Solaar](https://flathub.org/apps/io.github.pwr_solaar.solaar) | `flatpak install flathub io.github.pwr_solaar.solaar` <br> Linux manager for Logitech keyboards, mice, and trackpads.|
| [Oversteer](https://flathub.org/apps/io.github.berarma.Oversteer) | `flatpak install flathub io.github.berarma.Oversteer` <br> A steering wheel manager.|

## Gamedev

| Name & Link | Description & Manual CLI Installation |
|---|---|
| [Blender](https://flathub.org/apps/org.blender.Blender) | `flatpak install flathub org.blender.Blender` <br> The free and open source 3D creation suite that supports the entirety of the 3D pipeline: modeling, rigging, animation, simulation, rendering, compositing, motion tracking, and video editing.|
| [LibreSprite](https://flathub.org/apps/com.github.libresprite.LibreSprite) | `flatpak install flathub com.github.libresprite.LibreSprite` <br> LibreSprite lets you create 2D animations for videogames. From sprites, to pixel-art, retro style graphics, and whatever you like about the 8-bit (and 16-bit) era.|
| [Blockbench](https://flathub.org/apps/net.blockbench.Blockbench) | `flatpak install flathub net.blockbench.Blockbench` <br> Blockbench is a free, modern model editor for low-poly and boxy models with pixel art textures. Models can be exported into standardized formats, to be shared, rendered, 3D-printed, or used in game engines. There are also multiple dedicated formats for Minecraft Java and Bedrock Edition with format-specific features.|
| [Godot Engine](https://flathub.org/apps/org.godotengine.Godot) | `flatpak install flathub org.godotengine.Godot` <br> Cross-platform game engine to create 2D and 3D games from a unified interface1500s.|
| [Godot Engine (C#/.NET)](https://flathub.org/apps/org.godotengine.GodotSharp) | `flatpak install flathub org.godotengine.GodotSharp` <br> Cross-platform game engine to create 2D and 3D games from a unified interface.|
| [Godots](https://flathub.org/apps/io.github.MakovWait.Godots) | `flatpak install flathub io.github.MakovWait.Godots` <br> Godots is the ultimate hub for managing your Godot versions and projects.|

## Cool Stuff

| Name & Link | Description & Manual CLI Installation |
|---|---|
| [Concessio](https://flathub.org/apps/io.github.ronniedroid.concessio) | `flatpak install flathub io.github.ronniedroid.concessio` <br> Concessio helps you understand and convert between unix file permissions representations.|
| [Kile](https://flathub.org/apps/org.kde.kile) | `flatpak install flathub org.kde.kile` <br> Kile is a user-friendly TeX/LaTeX editor by KDE.|
| [Metronome](https://flathub.org/apps/com.adrienplazas.Metronome) | `flatpak install flathub com.adrienplazas.Metronome` <br> Metronome beats the rhythm for you, you simply need to tell it the required time signature and beats per minutes.|
| [Minuet](https://flathub.org/apps/org.kde.minuet) | `flatpak install flathub org.kde.minuet` <br> An application for music education. It features a set of ear training exercises regarding intervals, chords, scales and more.|
| [Halftone](https://flathub.org/apps/io.github.tfuxu.Halftone) | `flatpak install flathub io.github.tfuxu.Halftone` <br> Give your images a pixel art-like style and reduce the file size in the process with Halftone.|
| [Marknote](https://flathub.org/apps/org.kde.marknote) | `flatpak install flathub org.kde.marknote` <br> Marknote lets you create rich text notes and easily organize them into notebooks.|
| [Eloquent](https://flathub.org/apps/re.sonny.Eloquent) | `flatpak install flathub re.sonny.Eloquent` <br> Your proofreading assistant.|
| [IP Lookup](https://flathub.org/apps/io.github.bytezz.IPLookup) | `flatpak install flathub io.github.bytezz.IPLookup` <br> Look up details such as the internet provider and geographic location for an IP address.|
| [Frog](https://flathub.org/apps/com.github.tenderowl.frog) | `flatpak install flathub com.github.tenderowl.frog` <br> Extract text from images.|
| [NormCap](https://flathub.org/apps/com.github.dynobo.normcap) | `flatpak install flathub com.github.dynobo.normcap` <br> Capture text from any screen area.|
| [Iotas](https://flathub.org/apps/org.gnome.World.Iotas) | `flatpak install flathub org.gnome.World.Iotas` <br> Iotas aims to provide distraction-free note taking via its mobile-first design.|
| [OpenBoard](https://flathub.org/apps/ch.openboard.OpenBoard) | `flatpak install flathub ch.openboard.OpenBoard` <br> An open source cross-platform teaching software for interactive whiteboard designed primarily for use in schools and universities.|
| [OBS Studio](https://flathub.org/apps/com.obsproject.Studio) | `flatpak install flathub com.obsproject.Studio` <br> Open Broadcaster Software is free and open source software for video capturing, recording, and live streaming.|
