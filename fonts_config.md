...
- [Archivo](https://fonts.google.com/download?family=Archivo)
...
- [Superstar Memesbruh03](https://memesbruh03.neocities.org/)
- [Architects Daughter](https://fonts.google.com/download?family=Architects%20Daughter)
- [Cookie](https://fonts.google.com/download?family=Cookie)
- [Nanum Pen Script](https://fonts.google.com/download?family=Nanum%20Pen%20Script)
- [Press Start 2P](https://fonts.google.com/download?family=Press%20Start%202P)
- [Bungee](https://fonts.google.com/download?family=Bungee)
- [Codystar](https://fonts.google.com/download?family=Codystar)
- [Handlee](https://fonts.google.com/download?family=Handlee)
- [Julius Sans One](https://fonts.google.com/download?family=Julius%20Sans%20One)
- [Marck Script](https://fonts.google.com/download?family=Marck%20Script)
- [Merienda](https://fonts.google.com/download?family=Merienda)
- [Poiret One](https://fonts.google.com/download?family=Poiret%20One)
- [Philosopher](https://fonts.google.com/download?family=Philosopher)
- [Parisienne](https://fonts.google.com/download?family=Parisienne)
